  ...
  return (
    <div>
      <div class="container mt-5">
        <div class="card p-4">
          <h2 class="text-center mb-4">Change Student Details</h2>
              ...
              <div class="col-md-6 mb-3">
                <div class="input-group">
                  ...
                  <input
                    ...
                    value={lead.college}
                    onChange={(e) =>
                      setLead({ ...lead, college: e.target.value })
                    }
                  />
                </div>
              </div>
              <div class="col-md-6 mb-3">
                <div class="input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setLead({ ...lead, qualification: e.target.value })
                    }
                  />
                </div>
              </div>
              <div class="col-md-6 mb-3">
                <div class="input-group">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setLead({ ...lead, passout_year: e.target.value })
                    }
                  />
                </div>
              </div>
              ...
              <div class="col-md-6 mb-3">
                ...
                <div class="input-group">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setLead({ ...lead, course_mode: e.target.value })
                    }
                  >
